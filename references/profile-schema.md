...
最小字段：`schema_version`、`profile_id`、`ports`、`initialization_patterns`、`restart_patterns`、`commands`、`correlation`、`player_markers`、`observations`。
...
- `raw_tags`：设备实际标签名和值，以及端口、角色、游标、时间戳和证据路径。
